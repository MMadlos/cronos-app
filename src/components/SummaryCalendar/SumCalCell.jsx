export default function SumCalCell({ content, dataType }) {
	return (
		<div
			...
			data-type={dataType}
		>
			<div className="flex size-8 items-center justify-center rounded-full group-data-[type=full]:bg-green-300 group-data-[type=none]:bg-zinc-200 group-data-[type=partial]:bg-yellow-500">
